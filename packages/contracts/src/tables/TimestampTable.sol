...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16(""), bytes16("TimestampTable"))));
uint256 constant TimestampTableTableId = _tableId;

library TimestampTable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TimestampTable", _fieldNames);
  }
